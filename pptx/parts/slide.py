...
class SlidePart(BaseSlidePart):
    ...
    def get_or_add_video_media_part(self, video_path, content_type):
        ...
        appears to be for legacy support for an earlier PowerPoint media
        embedding strategy.
        """
        media_part = self._package.get_or_add_media_part(
            video_path, content_type
        )
